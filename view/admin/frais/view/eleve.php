<?php session_start(); 
	...
	require_once('../model/calcul-somme.php');
					...
					<form action="" method="GET">
						<div class="form-group mb-0">
							...
							<input
								...
								placeholder="Mettez le matricule de l'élève" name="motcle" value="<?php echo ($mc) ?>" 
							/>
							<div class="dropdown">
								<a
				...
				<div class="user-info-dropdown">
					<div class="dropdown">
						<a
							...
							data-toggle="dropdown"
						>
							<span class="username"><?= $_SESSION['nom']." (".$_SESSION['role'].")" ?></span>
						</a>
						<div
		...
		<div class="main-container">
			<div class="xs-pd-20-10 pd-ltr-20">
				<div class="card-box pb-10">
					<div class="h5 pd-20 mb-0">LISTE DES ELEVES &nbsp;&nbsp;
										&nbsp;&nbsp;
							...
							<tbody>
								...
								<tr>
									...
									<td><?php if ($et['montant']==0) {
											echo "<a class='btn btn-success'>".'En Ordre'."</a>";
										}else{?>
											<?php  echo($et['montant']."$")?>
								<?php } ?></td>
									<td><?php  echo($et['annee_scolaire'])?></td>
								<td>
								<a href="./editer-eleve.php?id=<?php echo($et['id_candidat'])?>" class="btn btn-primary">Editer</a>
								</td>
								<td>
								<a href="./impression-code.php?id=<?php echo($et['matricule'])?>" class="btn btn-primary">Imprimer Situation des Frais</a>
								</td>
											</tr>	
									<?php } ?>	
							</tbody>
				...
				<div class="footer-wrap pd-20 mb-20 card-box">
					Ecole Kimbwala - Ce site a été developpé par
					<a href="#"
						>KONDJO Moïse</a
					>
				</div>
